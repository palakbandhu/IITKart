...
export declare const requestEmailUpdate: (req: AuthRequest, res: Response, next: NextFunction) => Promise<void>;
export declare const verifyEmailChange: (req: AuthRequest, res: Response, next: NextFunction) => Promise<void>;
